...
if __name__ == '__main__':
    ...
    if judge_select(select):
        print("因为相同左部产生式的select集的交集不为空，故该文法不是LL(1)文法")
    else:
        print("该文法是LL(1)文法")
